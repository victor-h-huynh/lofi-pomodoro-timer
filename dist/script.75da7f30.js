...
function changeBackground() {
  ...
  count++; // mainElement.style.backgroundImage = `url(../static/background${backgroundNumber}.gif)`;

  mainElement.setAttribute("style", "background-image: url(./static/background".concat(backgroundNumber, ".gif)"));
} /////////////////////////////////////////////////////////////////////
// YouTube Script
